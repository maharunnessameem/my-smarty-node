...
app.get('/', (req, res) => {
    res.send('Hello from my over own Smarty Pant !! with auto restart')
});
...
const users = [
    ...
    { id: 4, name: 'Srabonti', email: 'srabonti@gmail.com', phone: '0178888888' },
    { id: 5, name: 'Suchonda', email: 'suchonda@gmail.com', phone: '0178888888' },
